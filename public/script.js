...
const lightVars = {
    ...
    "--heroBgImage": 'url("../images/69791a08-d8f7-4cd2-8986-4c0b0f428c93_removalai_preview.png")',
};
...
const darkVars = {
    ...
    "--heroBgImage": 'url("../images/84a03b24-9911-4b7e-b1b8-25f47a5a6f17_removalai_preview.png")',
};
...
function openProjectModal(data) {
    ...
    projectModalImg.src = `../images/${data.imgSlug}`;
